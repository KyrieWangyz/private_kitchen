...
import com.youdu.R;
import com.youdu.util.SettinTextWatcher;
...
public class IatSettings extends PreferenceActivity implements OnPreferenceChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mVadbosPreference.getEditText().addTextChangedListener(new SettinTextWatcher(IatSettings.this,mVadbosPreference,0,10000));
		
		mVadeosPreference = (EditTextPreference)findPreference("iat_vadeos_preference");
		mVadeosPreference.getEditText().addTextChangedListener(new SettinTextWatcher(IatSettings.this,mVadeosPreference,0,10000));
	}
	@Override
