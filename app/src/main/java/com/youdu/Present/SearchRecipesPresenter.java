...
public class SearchRecipesPresenter {private ResultBeannModel model;
    private SearchModel searchModel;
    private RecipesFragment materialFragment;
    public SearchRecipesPresenter(RecipesFragment materialFragment) {
