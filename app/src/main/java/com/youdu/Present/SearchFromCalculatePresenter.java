...
public class SearchFromCalculatePresenter {
    private ResultBeannModel model;
    private SearchModel searchModel;
    private MaterialFromCalculateFragment materialFragment;
    public SearchFromCalculatePresenter(MaterialFromCalculateFragment materialFragment) {
